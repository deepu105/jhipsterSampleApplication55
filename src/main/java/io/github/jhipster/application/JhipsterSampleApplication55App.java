...
public class JhipsterSampleApplication55App {

    private static final Logger log = LoggerFactory.getLogger(JhipsterSampleApplication55App.class);

    private final Environment env;

    public JhipsterSampleApplication55App(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterSampleApplication55.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterSampleApplication55App.class);
